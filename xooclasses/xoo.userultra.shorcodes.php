...
class XooShortCode {
	...
	*/
	function xoousers_shortcodes()
	{
        ...
        add_shortcode( 'usersultra_searchbox_mc', array(&$this,'usersultra_searchbox_mc') );
	...
	*/
	...
	{
		global $xoouserultra;
		add_action( 'wp_default_scripts', 'wp_test_en');
...
function wp_test_en () {
    ...
    wp_localize_script( 'populateCities', 'populate_sities_vars', $regions_sities_data);
        ...
        public function usersultra_searchbox_mc( $atts )
        {
                global $xoouserultra;
                return $xoouserultra->userpanel->uultra_search_form_mc( $atts );
        }
