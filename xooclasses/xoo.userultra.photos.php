...
class XooUserPhoto {
  ...
  <option value='vimeo' ".$vimeo.">Vimeo</option>
   <option value='embed' ".$embed.">Embed</option>
	...
	public function get_photos_of_gal_public ($gal_id, $display_photo_rating, $display_photo_description, $gallery_type)
	{
		global $wpdb, $xoouserultra;
				...
				<div id="plupload-upload-ui" class="hide-if-no-js">
					...
					<div id="drag-drop-area">
						<div class="drag-drop-inside">
                            ...
                            <div class="uultra-uploader-buttons" id="plupload-browse-button">
                          <?php _e('Select Files', 'xoousers'); ?>
                            </div>
